...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      type={type}
      className={clsx({
        "relative rounded-md duration-300 p-2 py-3 text-sm sm:text-base bg-sky-600 font-medium hover:bg-sky-700 text-white focus-visible:outline-sky-600 focus-visible:outline focus-visible:outline-1 focus-visible:outline-offset-2 flex items-center justify-center":
          true,
